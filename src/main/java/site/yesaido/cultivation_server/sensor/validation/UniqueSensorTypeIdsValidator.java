...
public class UniqueSensorTypeIdsValidator implements ConstraintValidator<UniqueSensorTypeIds, List<SensorSettingRequest>> {

    @Override
    public boolean isValid(List<SensorSettingRequest> settings, ConstraintValidatorContext constraintValidatorContext) {
        if (settings == null) {
