...
class MushroomReferenceControllerTest {
    ...
    class RegisterMushroomReference {
        ...
        void registerMushroomReference() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/mushroom-references")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(s))
                    .andExpect(status().isCreated())
                    .andExpect(header().string("Location", containsString("http://localhost/api/v1/mushroom-references/1")));
    ...
    class UpdateMushroomReference {
        ...
        void updateMushroomReference() throws Exception {
            ...
            mockMvc.perform(put("/api/v1/mushroom-references/{mushroom-references}", mushroomReferenceId)
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(s))
    ...
    class DeleteMushroomReference {
        ...
        void deleteMushroomReference() throws Exception {
            ...
            mockMvc.perform(delete("/api/v1/mushroom-references/{mushroom-reference-id}", mushroomReferenceId))
                    .andExpect(status().isNoContent());
    ...
    class GetMushroomReference {
        ...
        void getMushroomReferenceById() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/mushroom-references/{mushroom-reference-id}", mushroomReferenceId))
